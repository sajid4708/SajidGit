...
class GitSearchRepoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_git_search_repo, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment GitSearchRepoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GitSearchRepoFragment().apply {
